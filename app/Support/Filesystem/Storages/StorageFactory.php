...
class StorageFactory
{
    ...
    {
        return tap(static::create(config_starter('filesystems.storages.publish.private')), static function (?Storage $storage) {
            if (is_null($storage)) {
    ...
    {
        return tap(static::create(config_starter('filesystems.storages.publish.public')), static function (?Storage $storage) {
            if (is_null($storage)) {
    ...
    {
        return tap(static::create(config_starter('filesystems.storages.local')), static function (?Storage $storage) {
            if (is_null($storage)) {
